...
insert into sha_dublinkernels select id, value from inv_dublinkernels where  not inv_dublinkernels.value='(:unas)'

replace into sha_dublinkernels select id, value from inv_dublinkernels where  not inv_dublinkernels.value='(:unas)'
