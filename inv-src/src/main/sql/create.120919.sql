...
CREATE  TABLE IF NOT EXISTS `inv_objects` (
  ...
  `who` VARCHAR(4096) NULL ,
  `what` VARCHAR(4096) NULL ,
  `when` VARCHAR(4096) NULL ,
  `where` VARCHAR(4096) NULL ,
...
-- -----------------------------------------------------
-- Table `inv_collection_object`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inv_collection_object`;
CREATE  TABLE IF NOT EXISTS `inv_collection_object` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `inv_dublins`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inv_dublins`;
CREATE  TABLE IF NOT EXISTS `inv_dublins` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `object_id` INT UNSIGNED NOT NULL ,
  `version_id` INT UNSIGNED NOT NULL ,
