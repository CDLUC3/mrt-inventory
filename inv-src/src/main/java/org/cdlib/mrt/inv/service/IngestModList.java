...
public class IngestModList
{
    private static final String NAME = "IngestModList";
        ...
        throws TException
    {
        ...
        try {
            ...
            if (parts.length != 2) {
                System.out.println("invalid parts length=" + parts.length +  "  - line=" + line);
                return;
            }
