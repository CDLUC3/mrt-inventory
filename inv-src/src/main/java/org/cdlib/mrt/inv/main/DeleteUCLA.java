...
public class DeleteUCLA
{
    ...
    public DeleteUCLA(Properties invProp, int nodeSeq, LoggerInf logger)
        throws TException
    {
    ...
    public DeleteUCLA(String dirPathS)
        throws TException
    {
        try {
            if (dirPathS == null) {
            ...
            throws TException
    {
        ...
        try {
            ...
            DeleteUCLA delUCLA = new DeleteUCLA(dirPath);
            delUCLA.process();
        ...
        try {
            ...
            for(batchCnt=1; batchCnt <= maxBatch; batchCnt++) {
                ...
                try {
                    ...
                    if ((batchCnt % mod) == 0) {
                        DateState currentDate = new DateState();
                        String startDate = currentDate.getIsoDate();
            ...
            DateState currentDate = new DateState();
            String completionDate = currentDate.getIsoDate();
