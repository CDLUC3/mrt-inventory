...
public class InvMainGetPrimary
{
    ...
    public InvMainGetPrimary(InvService service, LoggerInf logger)
        throws TException
    {
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            InvMainGetPrimary pl = new InvMainGetPrimary(service, logger);
            //File inFile = new File("/replic/test/localid-mapper/e2.txt");
        ...
        throws TException
    {
        try {
            ...
            getRow(objectID, ownerID, localIDs);
    ...
    private void getRow(Identifier objectID, Identifier ownerID, String localIDs)
        throws TException
    {
        try {
            LocalContainerState lcs = service.getPrimary(ownerID, localIDs);
