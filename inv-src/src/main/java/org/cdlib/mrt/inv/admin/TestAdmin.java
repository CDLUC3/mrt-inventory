...
public class TestAdmin
{
    ...
    public static void main_collectPrv(String[] argv) { // owner
    	...
    	try {
            ...
            String  processTypeS = "collection";
    ...
    public static void main_collectPub(String[] argv) { // owner
    ...
    public static void main_owner(String[] argv) { // owner
    ...
    public static void main_sla(String[] argv) {
    	...
    	try {
            ...
            connection = config.getConnection(false);
            logger = config.getLogger();
            AdminShare.AdminType  processType = AdminShare.AdminType.sla;
            Identifier slaID = new Identifier("ark:/99999/testsla"); // CDL UC3
